...
| TC-P-03 | POSITIVE | Admin memvalidasi bukti pembayaran | Klik tombol [✅ Sah (ACC)] pada Topik #FINANCE | Sistem otomatis mengirim pesan *BlastOrder* ke seluruh telegram mitra yang berstatus aktif. |  | PASS | |
| TC-P-04 | POSITIVE | Mitra mengklaim order (Tercepat) | Mitra A menekan tombol [⚡ Ambil Order] pertama kali | Mitra A menerima notifikasi "Order Berhasil Diambil" beserta detail alamat pelanggan. | [Diisi setelah testing] | [PASS/FAIL] |  |
| TC-P-05 | POSITIVE | Admin QC menyetujui foto bukti kerja | Klik tombol [✅ Setujui] pada foto kerja di Topik #SERVICES | Pelanggan menerima pesan "Pekerjaan Selesai" dan tombol konfirmasi *Rating*. |  | [PASS/FAIL] |  |
